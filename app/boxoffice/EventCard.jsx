...
const EventCard = () => {
  return (
    <span className="shadow bg-white text-white overflow-hidden group font-bold relative aspect-[1/1.5] hover:scale-105 rounded-md transition-all duration-250 antialiased">
      ...
      <div className="z-10 bg-white/[1%] blur-sm group-hover:bg-white/[2%] absolute inset-0 -rotate-[70deg] translate-x-[0px] translate-y-[-200px] pointer-events-none group-hover:translate-x-0 group-hover:translate-y-[-175px] transition-all duration-100" />
